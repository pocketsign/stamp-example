...
const VERIFY_ERROR_MESSAGES: Record<VerifyErrorReasonKey, string> = {
	...
	ERROR_REASON_CONSENT_SERVICE_CERTIFICATE_NOT_SYNCED_YET: "証明書情報が同期されていません。",
	...
	ERROR_REASON_PERSONAL_INFO_LATEST_CERTIFICATE_CONTENT_NOT_EXISTS: "最新の証明書が存在しません。",
	ERROR_REASON_PERSONAL_INFO_REQUEST_CERTIFICATE_ON_HOLD: "証明書が一時保留状態です。",
